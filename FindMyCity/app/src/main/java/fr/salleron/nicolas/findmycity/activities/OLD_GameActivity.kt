 ...
 */
class OLD_GameActivity : AppCompatActivity(), GoogleMap.OnMapClickListener, StreetViewPanorama.OnStreetViewPanoramaChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        streetViewPanoramaFragment?.getStreetViewPanoramaAsync(({
            ...
            mStreetViewPanorama?.setOnStreetViewPanoramaChangeListener(this@OLD_GameActivity)
        ...
        mapFragment?.getMapAsync { map ->
            map.setOnMapClickListener(this@OLD_GameActivity)
    ...
    private fun showDialogAndNext(p0: LatLng?) {
        ...
        val dialog = FancyGifDialog.Builder(this@OLD_GameActivity)
        ...
        if (Math.ceil((distanceBeetweenMarker[0] / 1000).toDouble()) > 1000) {
            ...
            dialog.setTitle("Bravo ! \nTu es super fort !\n" +
                    ...
                    " km de l'objectif\n" +
                    "C'était : " + arrayCity[currentCity].name)
            dialog.setGifResource(R.drawable.gif_50)   //Pass your Gif here
